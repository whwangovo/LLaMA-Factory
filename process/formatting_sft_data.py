...
if __name__ == "__main__":
    input_json_file = "data/dpo@zhulong@2@20250306_predict.json"  # Replace with your input JSON file
    output_json_file = "data/dpo@zhulong@2@20250306_predict.json"  # Replace with your desired output JSON file
